        ...
        <main className="min-h-screen pt-32 pb-16 px-6 sm:px-12 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto z-10 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {capabilities.map((cap, idx) => (
                        <motion.div
                            ...
                            className="group relative p-8 bg-zinc-900/40 border border-zinc-800 rounded-2xl overflow-hidden hover:border-zinc-700 transition-colors"
                        >
                            ...
                            <div className="relative z-10">
                                <div className="mb-6 p-4 bg-black/50 border border-zinc-700/50 rounded-xl inline-block shadow-lg">
                                    {cap.icon}
                                </div>

                                <h2 className="text-2xl font-bold text-zinc-100 mb-3">{cap.title}</h2>
                                ...
                                <div className="flex flex-wrap gap-2 pt-6 border-t border-zinc-800/60">
                                    {cap.stats.map(stat => (
                                        <span key={stat} className="text-xs font-mono text-zinc-500 bg-zinc-950 px-3 py-1 rounded-full border border-zinc-800">
                                            /{stat}
                                        </span>
                                    ))}
                                </div>
                ...
                <motion.div
                    ...
                    className="mt-24 p-6 border border-zinc-800 bg-black/60 rounded-xl max-w-2xl mx-auto text-center"
                >
                    <div className="flex items-center justify-center gap-2 mb-2">
                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                        <span className="text-sm font-mono text-emerald-400 uppercase tracking-widest">System Online</span>
                    </div>
                    <p className="text-zinc-500 text-sm font-mono">
                        Ready to initialize new protocols. Open for collaboration.
                    </p>
                    <a href="mailto:yasinsteve4@gmail.com" className="inline-block mt-4 px-6 py-2 bg-zinc-800 text-zinc-300 font-mono text-sm hover:bg-zinc-700 transition-colors rounded">
