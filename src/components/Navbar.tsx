    ...
    return (
        <nav className="fixed top-0 w-full z-50 border-b border-zinc-200 dark:border-zinc-800/50 bg-white/80 dark:bg-black/40 backdrop-blur-md transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                <Link href="/" className="font-mono text-cyan-600 dark:text-cyan-400 font-bold tracking-wider hover:text-cyan-500 dark:hover:text-cyan-300 transition-colors text-sm sm:text-base">
                    MD_YASIN_
                </Link>
                <div className="flex items-center gap-3 sm:gap-8 text-xs sm:text-sm font-medium">
                    <div className="flex gap-3 sm:gap-8 text-zinc-600 dark:text-zinc-400">
